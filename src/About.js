    ...
    return (
        <div style={{fontFamily: "Klee One", paddingLeft: "5%", paddingRight:"5%"}}>
            ...
            <div style={{textAlign: "left"}}>
                <p style={{color: "#c7a2c4", fontWeight: "bold", fontSize: "110"}}> Who We Are </p>
                ...
                <p style={{color: "#c7a2c4", fontWeight: "bold", fontSize: "110%"}}>How We Chose the Name</p>
            ...
            <div>
                <p style={{color: "#c7a2c4", fontWeight: "bold", fontSize: "150%"}}>FAQ</p>
                <p style={{color: "#c7a2c4", fontWeight: "bold"}}>Who can purchase stickers? (In pink purple color)</p>
                ...
                <p style={{color: "#c7a2c4", fontWeight: "bold"}}>When will I get my order? (In the pink purple color)</p>
                ...
                <p style={{color: "#c7a2c4", fontWeight: "bold"}}>Can we request new sticker designs? (In the pink purple)</p>
                <p style={{color: "gray"}}>We will have a request for you to submit sticker ideas/requests and if we like it, we may choose it! If your design gets chosen we will give you a free sticker of your design!</p>
                <br/>
            </div>
</div>
        </div>
